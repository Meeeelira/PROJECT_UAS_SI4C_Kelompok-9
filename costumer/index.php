...
if (isset($_POST["order"])) {
  ...
  ('','$pengirim','$nb',$jb, $hb, '$k', '$u', '$ket', $create_at,$update_at)");

  if (mysqli_affected_rows($koneksi) > 0) {
    echo "
            <script>
                alert('Pesanan anda berhasil di tambahkan!');
                document.location.href = 'hal-refrensi/pemesanan.php';
            </script>
        ";
  }else {
...
if (isset($_POST["cs"])) {
  ...
  mysqli_query($koneksi,"INSERT INTO tb_cs VALUES
  ('','$pengirim','$nm','$em', '$sj','$ket', $create_at,$update_at)");

  if (mysqli_affected_rows($koneksi) > 0) {
    echo "
            <script>
                alert('Aduan anda berhasil di kirim!');
            </script>
        ";
  }else {
    echo mysqli_error($koneksi);
...
<head>
  ...
  <title>Sistem Informasi Penjualan Butik <b>Costumer Page.com</b></title>
...
<body>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="hal-refrensi/pemesanan.php">Pemesanan</a></li>
  ...
  <section id="hero">
    <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <!-- Slide 1 -->
        <div class="carousel-item active" style="background-image: url(card/card1.png)">
          <div class="container">
        ...
        <!-- Slide 2 -->
        <div class="carousel-item" style="background-image: url(card/card2.png)">
          <div class="container">
            <h2>Info Lokasi</h2>
            <p>Butik Ini berlokasi di Dusun 7, Desa Pulau Tanjung, Kecamatan Teluk Dalam, Kabupaten Asahan.</p>
            <a href="#contact us" class="btn-get-started scrollto">Read More</a>
          </div>
        </div>

        <!-- Slide 3 -->
        <div class="carousel-item" style="background-image: url(card/card3.png)">
          <div class="container">
            ...
            <a href="#pemesanan" class="btn-get-started scrollto">Read More</a>
          </div>
        </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row pt-5">
          <div class="col-md-3 d-flex align-items-stretch mb-5 mb-lg-0">
             <img src="galeri/dewasapria.png" class="img-fluid" alt="">
            </div>

          <div class="col-md-3 d-flex align-items-stretch mb-5 mb-lg-0">
              <img src="galeri/dewasawanita.png" class="img-fluid" alt="">
            </div>
         
          <div class="col-md-3 d-flex align-items-stretch mb-5 mb-lg-0">
              <img src="galeri/anakpria.png" class="img-fluid" alt="">
            </div>

          <div class="col-md-3 d-flex align-items-stretch mb-5 mb-lg-0">
              <img src="galeri/anakwanita.png" class="img-fluid" alt="">
            </div>
        </div>
      </div>
    </section><!-- Galery -->
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6" data-aos="fade-right">
            <img src="card/card1.png" class="img-fluid" alt="">
          </div>
  ...
  <img src="card/card7.png" class="card-img-top" alt="...">
  <div class="card-body">
...
<div class="col-md-4 p-5">
    <div class="card" style="width: 18rem;">
  <img src="card/card5.png" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">One Set Wanita Dewasa</h5>
    <p class="card-text">Bahan : Crinkle.</p>
    <p class="card-text">Size : S M L XL .</p>
    <a class="btn btn-primary">120.000</a>
  </div>
</div>
</div>
<div class="col-md-4 p-5">
    <div class="card" style="width: 18rem;">
  <img src="card/card6.png" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Piyama Pria Dewasa</h5>
    <p class="card-text">Bahan : Katun.</p>
    <p class="card-text">Size : S M L XL .</p>
    <a class="btn btn-primary">90.000</a>
  </div>
</div>
</div>
...
<div class="col-md-4 p-5">
    <div class="card" style="width: 18rem;">
  <img src="card/card9.png" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Atasan Anak Wanita</h5>
    <p class="card-text">Bahan : Moscrape.</p>
    <p class="card-text">Size : S M L XL .</p>
    <a class="btn btn-primary">150.000</a>
  </div>
</div>
</div>
...
<div class="col-md-4 p-5">
    <div class="card" style="width: 18rem;">
  <img src="card/card10.png" class="card-img-top" alt="...">
  <div class="card-body">
...
<div class="col-md-4 p-5">
    <div class="card" style="width: 18rem;">
  <img src="card/card11.png" class="card-img-top" alt="...">
  <div class="card-body">
  ...
  <!-- ======= End Detail Baju ======= -->
    ...
    <section id="pemesanan" class="appointment section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="text-center mt-4"><button class="btn btn-lg btn-primary text-light" type="submit" name="order" id="order" >ORDER DISINI</button></div>
        </form>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="gallery-slider swiper">
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide"><a class="gallery-lightbox" href="card/card4.png"><img src="card/card4.png" class="img-fluid" alt=""></a></div>
            <div class="swiper-slide"><a class="gallery-lightbox" href="card/card5.png"><img src="card/card5.png" class="img-fluid" alt=""></a></div>
            <div class="swiper-slide"><a class="gallery-lightbox" href="card/card6.png"><img src="card/card6.png" class="img-fluid" alt=""></a></div>
            <div class="swiper-slide"><a class="gallery-lightbox" href="card/card7.png"><img src="card/card7.png" class="img-fluid" alt=""></a></div>
            <div class="swiper-slide"><a class="gallery-lightbox" href="card/card8.png"><img src="card/card8.png" class="img-fluid" alt=""></a></div>
            <div class="swiper-slide"><a class="gallery-lightbox" href="card/card9.png"><img src="card/card9.png" class="img-fluid" alt=""></a></div>
            <div class="swiper-slide"><a class="gallery-lightbox" href="card/card10.png"><img src="card/card10.png" class="img-fluid" alt=""></a></div>
            <div class="swiper-slide"><a class="gallery-lightbox" href="card/card11.png"><img src="card/card11.png" class="img-fluid" alt=""></a></div>
          </div>
    ...
    <section id="contact us" class="contact us">
      ...
      <div>
        <iframe style="border:0; width: 100%; height: 350px;" src="card/card2.png" frameborder="0" allowfullscreen></iframe>
      </div>
      ...
      <div class="container">
        ...
        <div class="row mt-5">
          ...
          <div class="col-lg-6" style="border: 1px solid black; border-radius: 10px;" >
            <form action="" method="post" role="form" style="box-shadow: 5px;" class="m-3" >
              <div class="row">
              ...
              <div class="text-center"><button type="submit" class="btn btn-primary mt-2 mb-2" name="cs" >Send Message</button></div>
            </form>
          </div>
