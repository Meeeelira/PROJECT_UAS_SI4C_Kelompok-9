...
<head>
  ...
  <title>Sistem Informasi Penjualan Butik <b>Owner-transactions Page.com</b></title>  <meta content="" name="description">
    ...
    <tbody>
        ...
        <?php foreach ($dt as $data ) : ?> 
            ...
            <tr>
                ...
                <td><?= $t;?></td>
                <td>
                    <button class="btn btn-sm btn-primary ms-2 me-2"><a href="p-trans.php?id=<?= $data["Id_Barang"];?>" class="text-light">Proses</a></button>
                    <button class="btn btn-sm btn-danger ms-2 me-2"><a href="hps-trans.php?id=<?= $data["Id_Barang"];?>" onclick="return confirm('Yakin ingin mengahpus pesanan ini ?');" class="text-light">Hapus</a></button>
