...
<head>
  ...
  <title>Sistem Informasi Penjualan Butik <b>Owner-print-trans Page.com</b></title>  <meta content="" name="description">
...
<div class="row mt-3">
          ...
          <div class="row">
            ...
            <div class="col-md-8 text-left">Rp. <?= $data['JumlahBarang'] ?></div>
          </div>
          <div class="row">
