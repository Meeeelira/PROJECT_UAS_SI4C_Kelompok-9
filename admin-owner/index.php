...
<head>
  ...
  <title>Sistem Informasi Penjualan Butik <b>Owner Page.com</b></title>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li class="dropdown"><a href="#kategori"><span>Data</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  <li><a href="hal-refrensi/ds-user.php">User</a></li>
                  </ul>
              </li>
          <li><a class="nav-link scrollto" href="hal-refrensi/transaksi.php">Transaksi</a></li>
          <li><a class="nav-link scrollto" href="hal-refrensi/pemesanan.php">Pemesanan</a></li>
          <li><a class="nav-link scrollto" href="hal-refrensi/cs.php">Aduan</a></li>
          <li><a class="nav-link scrollto " href="hal-refrensi/laporan.php">Laporan</a></li>
        ...
        <div class="row mt-5">
          ...
          <div class="col-lg-6">
            <form action="" method="post" role="form" >
              ...
              <div class="text-center"><button type="submit" class="btn btn-primary mt-2" name="mesage" >Send Message</button></div>
            </form>
          </div>
